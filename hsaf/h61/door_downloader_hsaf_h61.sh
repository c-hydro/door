...
# Script argument(s)
data_folder_static_geo="/share/HSAF_PRECIPITATION/ancillary/geo/h61/"
data_folder_static_grid="/share/HSAF_PRECIPITATION/ancillary/grid/h61/"
data_folder_dynamic_src_raw="/share/HSAF_PRECIPITATION/nrt/h61/%YYYY/%MM/%DD/"
data_folder_dynamic_dst_raw="/share/HSAF_PRECIPITATION/dewetra/h61_corrected_extrapolation/%YYYY/%MM/%DD/%HH00/"
...
if [ "$script_mode" == 'realtime' ]; then
	ftp_folder_raw="/products/h61/h61_cur_mon_data/" # realtime
