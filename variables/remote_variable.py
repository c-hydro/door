...
from ..data_sources import DOORDataSource
#from ..lib.log import log
#from ..lib.io import save_dataset_to_geotiff, check_data
from ..lib.time import TimeRange
#from ..lib.space import Grid

from .door_variable import DOORvariable

class RemoteVariable(DOORvariable):
    def __init__(self, data_source: DOORDataSource, variables: dict, type: str, src_format: str, dst_format: str, destination: str, ancilllary: str) -> None:
