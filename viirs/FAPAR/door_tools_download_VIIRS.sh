...
# Execution example:
# ./door_tools_download_VIIRS.sh
#-----------------------------------------------------------------------------------------

#-----------------------------------------------------------------------------------------
# Get file information
script_file=${script_folder}'downloader_VIIRS.py'
settings_file=${configuration_folder}'downloader_VIIRS_FAPAR_VNP15A2H.json'
